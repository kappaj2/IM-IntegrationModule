package za.co.ajk.integration.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("IntegrationModule");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("IntegrationModule");
        ...
        config.getMapConfigs().put("za.co.ajk.integration.domain.*", initializeDomainMapConfig(jHipsterProperties));
